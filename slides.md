...
Rails v7では、マイグレーションも含めてネイティブの列挙型のサポートが、本当に良くなりました。以前のバージョンのRailsの場合、ネイティブのenumを使いたいなら、activerecord-postgres_enumというジェムを使ってください。
-->
...
## Oh no, I'm out of time for this! ⏱

Look yourself in the full version of these slides:

<div class="text-center text-xl">

<qr-code url="https://envek.github.io/kaigionrails-postgresql-as-seen-by-rubyists/39" class="w-72 mx-auto my-12" />

[envek.github.io/kaigionrails-postgresql-as-seen-by-rubyists/39](https://envek.github.io/kaigionrails-postgresql-as-seen-by-rubyists/39)
...
PostgreSQLでは複合型を作る方法と、ActiveRecordを使って、どのようにRubyオブジェクトに変換する方法、逆にデータベースに書き込むために変換する方法などをご存知になります。

このリンクを使って自分で勉強してみてくださいね！
-->
